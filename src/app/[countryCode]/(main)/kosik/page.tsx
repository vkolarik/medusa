...
const CartPage: NextPage = () => {
  ...
  return <main className="page max-width w-full">
    ...
    {cartProducts.length > 0 ? <>
      ...
      <form className="flex h-full lg:flex-row flex-col"
        ...
        <div className="h-full lg:border-r border-lightGrey py-5 xl:pr-10 pr-5 lg:w-1/2 w-full">
          <div className="flex items-center gap-3">
            <button className={`${accountStatus === AccountStatus.GUEST ? "button button--small" : "button button--light button--small"}`}
              ...
              type="button">Pokračovat bez přihlášení</button>
            ...
            <button className={`${accountStatus === AccountStatus.ACTIVE ? "button button--small" : "button button--light button--small"}`}
              ...
              type="button">Přihlásit se</button>
          </div>
          ...
          <div className="h-full">
            ...
            <div className="space-y-2 pt-5">
              <div className="flex justify-between w-full items-center font-medium">
                <p className="lg:text-[15px] md:text-[14px] text-[13px]">Součet</p>
                <p className="lg:text-[15px] md:text-[14px] text-[13px]">{calculateTotalPrice(cartProducts) + " Kč"}</p>
              </div>
              <div className="flex justify-between w-full items-center font-medium">
                <p className="lg:text-[15px] md:text-[14px] text-[13px]">Doprava</p>
                <p className="lg:text-[15px] md:text-[14px] text-[13px]">{deliveryPrice + " Kč"}</p>
              </div>
              <div className="flex justify-between w-full items-center font-medium lg:text-[35px] md:text-[23px] text-[20px]">
                <p className="lg:text-[19px] md:text-[17px] text-[15px]">Celkem</p>
                <p className="lg:text-[19px] md:text-[17px] text-[15px]">{calculateTotalPrice(cartProducts) + deliveryPrice + " Kč"}</p>
              </div>
            </div>
          </div>
