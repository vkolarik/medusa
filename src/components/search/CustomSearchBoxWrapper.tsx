...
export type CustomControlledSearchBoxProps = React.ComponentProps<"div"> & {
...
const CustomSearchBoxWrapper = ({
  children,
  placeholder = "Vyhledejte produkty...",
  ...rest
...
export default CustomSearchBoxWrapper
