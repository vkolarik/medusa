...
export const ProductDetailCalculator: FC<{ image: string }> = ({ image }) => {
  ...
  return <div className='flex gap-8 pt-8'>
...
className="basic-form basic-form--no-shadow basic-form--full-width">
        <h1 className="font-semibold lg:text-[27px] md:text-[22px] text-[18px] md:mb-5 mb-3">Zjistěte, jaká je Vaše ideální velikost</h1>

<Form data={productDetailCalculator}
register={register}
errors={errors} />

<div className="flex justify-end">
<SubmitButton text="Vypočítat"
color="light" />
</div>
  </form>
</div>
