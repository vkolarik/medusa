...
export const ProductDetailModal: FC<{ image: string, setActiveModal: Dispatch<SetStateAction<boolean>> }> = ({ image, setActiveModal }) => {
  const [headerState, setHeaderState] = useState<ProductDetailModalState>(ProductDetailModalState.CALCULATOR)
      ...
      <div ref={popupBgRef} className='popup-bg' />
        ...
        >
          <div ref={popupRef} className='info-popup__text pt-4 pb-8'>
            <div className='flex justify-end pb-2 border-b border-lightGrey'
              onClick={() => closeAlert()}>
            ...
            <div className='px-4 lg:px-8 md:pt-8 pt-4'>
              ...
              <div>
                ...
                {headerState === ProductDetailModalState.CALCULATOR ? <ProductDetailCalculator image={image} /> : <ProductDetailSizesTable />}

                <div className='pt-8'>
                  <h2 className='font-semibold lg:text-[22px] md:text-[19px] text-[16px] md:mb-3 mb-2'>Jak se správně měřit</h2>
                  <div className='md:mt-3 mt-2 border-t border-lightGrey'>
                    <h3 className='font-medium lg:text-[17px] text-[15px] md:mt-4 mt-2'>Prsa</h3>
                    <p>Metr protáhněte v podpaží a změřte se přes nejširší část svého poprsí.</p>
                    <h3 className='font-medium lg:text-[17px] text-[15px] md:mt-4 mt-2'>Pas</h3>
                    <p>Metr protáhněte podél svého přirozeného pasu a změřte vzdálenost mezi nejvyšší částí kyčelní kosti a spodními žebry.</p>
                    <h3 className='font-medium lg:text-[17px] text-[15px] md:mt-4 mt-2'>Boky</h3>
                    <p>Metr obtočte kolem svých boků a měřte přes nejširší část svého zadku.</p>
                  </div>
                </div>
              </div>
            </div>
