  ...
  return <footer className='border-t border-lightGrey'>
    <div className="max-width flex justify-between items-center gap-5 py-3 lg:flex-row flex-col">
      ...
      <div className="flex lg:w-full w-max lg:mx-0 mx-auto 2xl:gap-16 gap-8 lg:justify-start justify-center">
        <Link href={ROUTES.HOME}
            className="footer__logo lg:block hidden">
            <Image
              src={logo.src}
              alt="Trend Trove - logo"
              layout="fill"
        ...
        <ul className='space-y-2 lg:w-auto w-full'>
          ...
          {mainLinks.map((item: IHeaderDropdown, itemKey: number) => {
            ...
            return <li key={itemKey}
              className='link md:text-[15px] text-[14px]'>
      ...
      <div className='w-full lg:text-left text-center'>
        <span className='font-semibold lg:text-[20px] md:text-[18px] text-[15px]'>Děkujeme Vám za Vaši důvěru!</span>
        <p className='lg:my-3 my-1'>Každý Váš nákup je pro nás důležitý. Díky za Vaši důvěru! Sdílejte s přáteli naši stránku a pomozte nám rozšířit krásu módy dál.</p>
    ...
    <div className="footer__authors border-t border-lightGrey py-2">
      <div className="max-width">
        <p className='text-center font-medium'>© 2024 | Vojtěch Kolařík | Jakub Procházka | Libuše Babičková </p>
      </div>
    </div>
  </footer>
}
