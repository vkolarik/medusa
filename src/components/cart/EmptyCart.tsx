    ...
    <div className="max-width">
      <div className="sm:p-8 px-2 py-4 mx-auto flex justify-center items-center shadow-2xl lg:w-max">
        <div className="md:p-5 px-3 py-5 text-center">
          <h1 className="lg:text-[25px] md:text-[23px] text-[20px] font-semibold leading-1">
          ...
          <Image src={image.src}
            ...
            className="mx-auto md:my-6 my-2 md:w-[10rem] md:h-[10rem] w-[7rem] h-[7rem] object-contain"/>
